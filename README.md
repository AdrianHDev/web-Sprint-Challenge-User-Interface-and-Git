...
HTML that is self-explanatory in it's naming convention


2. Name two big differences between ```display: block;``` and ```display: inline;```.
Display: block will wrap to a new line every time, while in-line will not.

3. What are the 4 areas of the box model?
Content, Edge, Padding, Margin
